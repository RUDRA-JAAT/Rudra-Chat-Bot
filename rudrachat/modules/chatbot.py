...
from rudrachat.modules.helpers import CHATBOT_ON, is_admins


@rudrachat.on_cmd("chatbot", group_only=True)
...
async def chatbot_text(client: Client, message: Message):
    ...
    if not message.reply_to_message:
        RUDRAdb = MongoClient(MONGO_URL)
        RUDRA = RUDRAdb["RUDRADb"]["RUDRA"]
        is_RUDRA = RUDRA.find_one({"chat_id": message.chat.id})
        if not is_RUDRA:
